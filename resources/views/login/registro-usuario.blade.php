    ...
    <div class="auth-body auth-bg mt-20">
        ...
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('registro') }}" id="registerForm" class="form-cols">
                        ...
                        <div>
                            ...
                            <div class="auth-input-wrap">
                                ...
                                <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}"
                                    placeholder="Ana" class="auth-input {{ $errors->has('nombre') ? 'is-invalid' : '' }}"
                                    required>
                            </div>
                            @error('nombre')
                        ...
                        <div>
                            ...
                            <div class="auth-input-wrap">
                                ...
                                <input type="text" id="apellido" name="apellido" value="{{ old('apellido') }}"
                                    placeholder="García"
                                    class="auth-input {{ $errors->has('apellido') ? 'is-invalid' : '' }}" required>
                            </div>
                            @error('apellido')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <div class="auth-input-wrap">
                            ...
                            <input type="password" id="reg_password_confirmation" name="password_confirmation"
                                placeholder="Repite tu contraseña" class="auth-input" required>
                        </div>
                    </div>
                </div>
                ...
                {{-- COLUMNA DERECHA: dirección / facturación --}}
                <div class="form-col">
                    <p class="section-label">Datos de envío / facturación</p>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <div class="auth-input-wrap">
                                ...
                                <input type="text" name="estado_dir" class="auth-input"
                                    value="{{ old('estado_dir') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Términos y botón al fondo de la columna derecha --}}
                    <div class="mt-auto pt-4 space-y-4">
                        <div class="flex items-start gap-2">
                            ...
                            <label for="terminos"
                                class="text-sm text-gray-500 cursor-pointer leading-relaxed select-none">
                                Acepto los
                                <a href="#" class="text-[#E48F62] font-semibold hover:underline">términos y
                                    condiciones</a>
                                y el
                                <a href="#" class="text-[#E48F62] font-semibold hover:underline">aviso de
                                    privacidad</a>
                            </label>
                        </div>
                        @error('terminos')
